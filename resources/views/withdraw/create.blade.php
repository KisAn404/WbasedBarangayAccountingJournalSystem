...
@endif
    <div style="padding-left: 10% " class="d-flex align-items-center">
         <a class="btn btn-primary" href="{{ route('withdraw.index') }}"> Back</a><h1 class="my-header">Add withdraws</h1>   
    </div>
    <div class="card">
...
<div class="mb-3 row" >
    <label for="check_no" class="col-sm-3 col-form-label">Check No</label>
    <input style="width: 50%" style="height: 50px" type="number" name="check_no" required placeholder=""><br>
</div>
...
<div class="mb-3 row" >
    <label for="pb_no" class="col-sm-3 col-form-label">PB No</label>
    <input style="width: 50%" style="height: 50px" type="text" name="pb_no" required placeholder=""><br>
</div>
<div class="mb-3 row" >
