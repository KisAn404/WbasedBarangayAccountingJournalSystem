...
<div class="modal fade" id="expenseModal" tabindex="-1" role="dialog" aria-labelledby="expenseModalLabel" aria-hidden="true">
          ...
          <div class="modal-body">
            ...
            <form action="{{ route('expense.store') }}" method="POST">
                ...
                <div class="mb-3 row">
                    ...
                    <input style="width: 70%; height: 50px" type="text" class="form-control" name="type" id="type" value="expense" readonly>
                </div> 
            ...
            <div class="mb-3 row" >
        <label for="particulars" class="col-sm-3 col-form-label"style="font-size: 18px;margin-left: 10px;">Particulars</label>
    ...
    <div class="mb-3 row" >
        ...
        <select style="width: 70%" style="height: 50px" type="select" class="form-control" name="bank_account"  id="bank_account" required>
